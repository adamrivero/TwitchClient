...
namespace TwitchClient
{
    class StartServer
    {
        private string twitchClientId = "0pje11teayzq9z2najlxgdcc5d2dy1";
        private string twitchClientSecret = "9jix4zg8ssn01ux9bsj05degfvsxcm";
        ...
        public void TwitchAuthorizationApi(string code)
        {
            ...
            Debug.WriteLine($"Token: {myAuthResponse.access_token}");
